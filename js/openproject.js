                            ...
                            if (result && result.length > 0) {
                                ...
                                $.each(result,
                                    function(i, v) {
                                        ...
                                        if (i != 0) {
                                            filtereddata[objecti] =
                                                { from: lastdate, to: thisdate, state: laststatusname };
                                            objecti++;
                                ...
                                $("#time_entry_hours").closest("div").append(
                                    `<div class='timedetails timedetailsmodtheme'><div class='timedetailshead'><div class='timeloghead pad10'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white">
    ...
    <path d="M15.95 10.78c.03-.25.05-.51.05-.78s-.02-.53-.06-.78l1.69-1.32c.15-.12.19-.34.1-.51l-1.6-2.77c-.1-.18-.31-.24-.49-.18l-1.99.8c-.42-.32-.86-.58-1.35-.78L12 2.34c-.03-.2-.2-.34-.4-.34H8.4c-.2 0-.36.14-.39.34l-.3 2.12c-.49.2-.94.47-1.35.78l-1.99-.8c-.18-.07-.39 0-.49.18l-1.6 2.77c-.1.18-.06.39.1.51l1.69 1.32c-.04.25-.07.52-.07.78s.02.53.06.78L2.37 12.1c-.15.12-.19.34-.1.51l1.6 2.77c.1.18.31.24.49.18l1.99-.8c.42.32.86.58 1.35.78l.3 2.12c.04.2.2.34.4.34h3.2c.2 0 .37-.14.39-.34l.3-2.12c.49-.2.94-.47 1.35-.78l1.99.8c.18.07.39 0 .49-.18l1.6-2.77c.1-.18.06-.39-.1-.51l-1.67-1.32zM10 13c-1.65 0-3-1.35-3-3s1.35-3 3-3 3 1.35 3 3-1.35 3-3 3z"/>
</svg>Options</div></div><div class='timedetailsbody'><div class='timelog pad10'></div><div class='timelogsummary pad10'></div><div class='timelogoptions pad10'><div class='timedetailsformgroup'><label>Any Time Updations/Split time in records</label><input type='time' id='splittime' value='${
                                    splittimevalue
                                    }'/></div><div class='timedetailsformgroup'><label>What was the status</label><select id='splittimestatus'><option >Active</option><option >Inactive</option></select></div><div class='timedetailsformgroup pad10'><button class="button -highlight" type='button' id="splittimego">Change time details</button><p>If you set lock/inactive manually, you must manually unlock/active, otherwise computer lock events will not work on lock/shutdown pc</p></div></div></div></div>`);
                                ...
                                $.each(filtereddata,
                                    function(i, v) {
                                        ...
                                        var inactivetext =
                                            `<svg title="" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
...
<path d="M23 16c0 1.1-.9 2-2 2h-1l-2-2h3V4H6L4 2h17c1.1 0 2 .9 2 2v12zm-5.5 2l-2-2zm-2.6 0l6 6 1.3-1.3-4.7-4.7-2-2L1.2 1.8 0 3.1l1 1V16c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h.9zM3 16V6.1l9.9 9.9H3z"/>
                                        ...
                                        var activetext =
                                            `<svg xmlns="http://www.w3.org/2000/svg" title=""  width="24" height="24" viewBox="0 0 24 24">
<path d="M0 0h24v24H0z" fill="none"/>
<path d="M21 2H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h7v2H8v2h8v-2h-2v-2h7c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 14H3V4h18v12z"/>
</svg>`;


                                        $(".timedetails .timelog").append(
                                            `<div  data-status="${v.state}" class="timelogbox pad10" data-timefrom="${
                                            v.from.getHours() + ":" + v.from.getMinutes()}" data-timeto="${
                                            v.to.getHours() + ":" + v.to.getMinutes()}"  data-timespend="${diffMs
                                            }"><div class="timeline-icon "><p class="timeline-iconcontent">${timestring
                                            }</p></div>
                <div class="timeline-content" title="${v.state == "active"
                                            ? "You were active in this PC"
                                            : "You were not active in this PC"}">
                <p class="timeline-title">${v.state == "active" ? activetext : inactivetext
                                            }<span class="timlinetimespan"> ${diffHrs < 10
                                            ? "0" + diffHrs.toString()
                                            : diffHrs}H : ${diffMins < 10 ? "0" + diffMins.toString() : diffMins
                                            }M </span></p>
                    ...
                    <option value='7'>Playing Games</option>
                                        ...
                                        if (v.state == "inactive" && diffHrs > 6) {
                                            ...
                                            (diffHrs < 2 && (diffHrs >= 1 || (diffHrs == 0 && diffMins >= 10))) &&
                                            v.from >= daynoonstart &&
                                            v.to <= daynoonend) {
                                            lastselectbox.val(3);
                                        } else if (v.state == "inactive" &&
                                            ...
                                            ((diffHrs >= 1 || (diffHrs == 0 && diffMins >= 10)))) {
                                            lastselectbox.val(5);
                                        } else if (stopfillactivitydate && v.to > stopfillactivitydate) {
                                            lastselectbox.val(2);
                                        }
                                    ...
                                    function(changedUserActivities) {
                                        ...
                                        if ($(".templateselector .changetheme").val() == "mod") {
                                            $(".timedetails .timelog .timelogbox").each(function() {
                                                $(this).find(".timeline-content").css("margin",
                                                    ($(this).outerHeight() -
                                                        $(this).find(".timeline-content").outerHeight()) /
                                                    2 +
                                                    "px -3px");
                                            })
                                        }
...
// // datenow.setMinutes(seleteddate.getMinutes());
                        peek("currentUserActivities",
                            function(currentUserActivitiesList) {
                                currentUserActivitiesList.push({
                                    state: $("#splittimestatus").val() == "Active" ? "active" : "locked",
                                    ...
                                    function(result) {
                                        ...
                                        peek("currentUserActivities",
                                            function(currentUserActivities) {
                                                ...
                                                var allowedmilliseconds = (+timeParts[0] * (60000 * 60)) +
                                                    (+(timeParts[1] * 60 / 100) * 60000);
                                                    ...
                                                    .each(function() {
                                                        if (!idfoundreportedtime) {
                                                            ...
                                                            if (timeussed > allowedmilliseconds) {
                                                                var secondstoincrease = allowedmilliseconds -
                                                                    whatthelasttimeinseconds;
                                                                idfoundreportedtime = true;

                                                                reportedtime =
                                                                    new Date($("#time_entry_spent_on").val() +
                                                                        " " +
                                                                        $(this).attr("data-timefrom"));
                                                ...
                                                peekandsettime(function() {
                                                        setTimeout(function() {
                                                                ...
                                                                setTimeout(function() {
                                                                        ...
                                                                        $("#new_time_entry").find("[type=submit]")
                                                                            .show();
                                                                    },
                                                                    500);
                                                            },
            ...
            var changestatus = function(e, th) {
                ...
                $(".timelogbox").each(function() {
                    ...
                    var diffMins = Math.round(((timespend % 86400000) % 3600000) / 60000); // minutes
                ...
                var timespendforthistask = parseInt($(".timedetails .timelogsummary .timelogbox[data-statuscolor=1]")
                    .not("[data-disabled]").attr("data-timespend"));
                ...
                var diffMins = Math.round(((timespendforthistask % 86400000) % 3600000) / 60000); // minutes
